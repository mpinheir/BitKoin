...
class BitCoinHomeState extends State<BitCoinHome> {
  ...
  _loadPrefs() async {
    ...
    String coinDescription =
        prefs.getString('coinDescription') ?? "United States Dollar";
  ...
  _loadData() async {
    ...
    String dataURL = "https://api.coindesk.com/v1/bpi/currentprice/" +
        ...
        child: ListView(
          ...
          ListTile(
              ...
              onTap: () async {
                ...
                updateRate = await Navigator.of(context).push(PageRouteBuilder(
          ...
          children: [
            Column(
              children: [
                ...
                (_defaultCurrency == null)
                    ? Text("loading")
                    : Text('${_defaultCurrency.description}'),
              ],
            ),
            Column(children: [
